...
$page_title     = $page_for_posts ? get_the_title($page_for_posts) : __('Latest Posts', 'apl-theme');
?>

<main class="apl-blog">
    <h1 class="apl-blog__title"><?php echo esc_html($page_title); ?></h1>
    ...
    <?php else : ?>
        <div class="apl-blog-empty">
            <p><?php esc_html_e('No posts to show yet. Please check back soon!', 'apl-theme'); ?></p>
        </div>
    <?php endif; ?>
</main>
